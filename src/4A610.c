...
void func_80049A10(s16 idx) {
    ...
    switch (actor->status) {
        ...
        case 100:
            ...
            actor->unkA8.integer = (func_80011528(0) + 60) & 0x7F;
            actor->status = 101;
            break;
        case 101:
            actor->unkA8.integer--;
            ...
            break;
        case 110:
            actor->unkAC.fp = ((func_80011528(0) & 0x200) + actor->unkB4.fp) - 256.0f;
            actor->unkB0.fp = ((func_80011528(0) & 0x200) + actor->unkB8.fp) - 256.0f;

            actor->unkA8.integer = 10;
            actor->status = 111;
            break;
        case 111:
            func_80022F48(idx, 1);
            func_800256CC(actor, actor->unkAC.fp, actor->unkB0.fp, 3.0f);
            ...
            break;
        case 112:
            func_80024FC8(idx, actor->unkC0.fp, actor->unkBC.fp);

            actor->unkBC.fp -= D_80159170 * 0.5;
            actor->unkC4.fp = actor->pos.x;
            actor->unkC8.fp = actor->pos.z;
            ...
            if (D_800F9910.unk1 != 0 &&
                (actor->unkC0.fp * 0.3 <
                 actor->unkC0.fp - sqrtf(SQ(actor->pos.z - actor->unkC8.fp) + SQ(actor->pos.x - actor->unkC4.fp)))) {
                actor->rot.y += 180.0f;
                ...
                if (func_80024EA4(idx, actor->unkAC.fp, actor->pos.y, actor->unkB0.fp) < 100.0f ||
        ...
        case 113:
            ...
            if (actor->unkC0.fp < 0.1 && D_800F9910.unk0 != 0) {
                actor->status = 100;
            }
            break;
        case 120:
        ...
        case 301:
            ...
            if (v0 < 150.0f) {
                actor->unkAC.fp = D_800B5430[actor->unkCC.integer].unk0;
                actor->unkB0.fp = D_800B5430[actor->unkCC.integer].unk2;

                if (D_800B5430[actor->unkCC.integer].unk4 == 0) {
                    actor->unkCC.integer++;
                    actor->status = 303;
                    ...
                    if (actor->unkAC.fp == -1.0f && actor->unkB0.fp == -1.0f) {
                        D_800E6B20.unk20 = 0x4B;
                        D_800E6B20.unk22 = 0xB7;
        ...
        case 302:
            ...
            func_800256CC(actor, actor->unkAC.fp, actor->unkB0.fp, 20.0f);
            break;
        case 303:
            func_80022F48(idx, 1);
            func_800256CC(actor, actor->unkAC.fp, actor->unkB0.fp, 1.0f);

            if (D_800B5430[actor->unkCC.integer - 1].unk4 == 2) {
                GET_ACTOR_PTR(idx)->unkC0.fp = 4.0f;
                GET_ACTOR_PTR(idx)->unkBC.fp = 25.0f;
            } else {
                actor->unkBC.fp = D_800B5430[actor->unkCC.integer].unk8;
                actor->unkC0.fp = D_800B5430[actor->unkCC.integer].unkC;
            }
        ...
        case 304:
            ...
            if (D_800F9910.unk0 != 0) {
                if (func_80024EA4(idx, actor->unkAC.fp, actor->pos.y, actor->unkB0.fp) < 150.0f) {
                    if (D_800B5430[actor->unkCC.integer - 1].unk4 == 1) {
                        actor->unkD0.integer = 0, actor->status = 305;
                    } else {
                        actor->unkAC.fp = D_800B5430[actor->unkCC.integer].unk0;
                        actor->unkB0.fp = D_800B5430[actor->unkCC.integer].unk2;
                        actor->unkCC.integer++;
        ...
        case 351:
            ...
            if (id != -1) {
                actor1->flags |= 0x4000;
                actor->unkD4.integer = id;
                D_800F05B8 = 1;

                actor->unkA8.integer = 240;
        ...
        case 352:
            ...
            break;
        case 353:
            if (GET_ACTOR_PTR(actor->unkD4.integer)->pos.y < 550.0f && actor->unkBC.fp < 0.0f) {
                actor->unkA8.integer = 90;
                actor->status = 354;
            }

            actor->unkBC.fp -= D_80159170 * 0.125;
            GET_ACTOR_PTR(actor->unkD4.integer)->pos.y += actor->unkBC.fp;
            func_80022528(1, 2, GET_ACTOR_PTR(actor->unkD4.integer)->pos.x, GET_ACTOR_PTR(actor->unkD4.integer)->pos.y,
                          GET_ACTOR_PTR(actor->unkD4.integer)->pos.z, (f32)(func_80011528(0) & 0x3F),
        ...
        case 401:
            ...
            break;
        case 402:
            if (func_80012D40(4, actor->unkA8.integer + 5, 1U) == 0) {
                actor1->flags &= ~0x4000;
                actor->unkA8.integer++;

                if (actor->unkA8.integer >= 6) {
        ...
        case 405:
            ...
            break;
        case 406:
            if (GET_ACTOR_PTR(actor->unkD4.integer)->pos.y < 530.0f && actor->unkBC.fp < 0.0f) {
                actor->unkA8.integer = 90;
                actor->status = 407;
            }
            ...
            GET_ACTOR_PTR(actor->unkD4.integer)->pos.y += actor->unkBC.fp;
            func_80022528(1, 2, GET_ACTOR_PTR(actor->unkD4.integer)->pos.x, GET_ACTOR_PTR(actor->unkD4.integer)->pos.y,
                          GET_ACTOR_PTR(actor->unkD4.integer)->pos.z, (f32)(func_80011528(0) & 0xFF),
                          (f32)(func_80011528(0) & 0xFF), (f32)(func_80011528(0) & 0x1F));
        ...
        case 407:
            ...
            if (actor->unkA8.integer <= 0) {
                func_80022F20(actor->unkD4.integer, func_80039254);
                actor1->flags &= ~0x4000;
                D_800F05B8 = 0;
                func_8002263C(1);
                D_80142BCC = 255.0f;
        ...
        case 451:
            ...
            break;
        case 452:
            if (func_80012D40(4, actor->unkA8.integer + 11, 1U) == 0) {
                actor1->flags &= ~0x4000;
    ...
    if (actor->unk38 != 0xFFFF) {
        switch (actor->status) {
            ...
            case 12:
                ...
                actor->unkA8.fp -= D_80159170 * 0.25;
                func_80059760(actor);
