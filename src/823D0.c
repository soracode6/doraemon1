...
void func_800817D0(s32 arg0){
    ...
    if(D_800E69C0.unk3E[0].uchar[1] < ++D_800E69C0.unk3C.uchar[1]){
        if(D_800E69C0.unk3E[0].uchar[0] != 0){
            D_8016B0B0 = 255.0f; 
        }
        else{
            D_8016B0B0 = 0.0f;
        ...
        D_800E69C0.unk3E[0].uchar[0] ^= 1;
        D_800E69C0.unk3C.uchar[1] = 0; 
    }
    else{
        if(D_800E69C0.unk3E[0].uchar[0] != 0){
...
void func_8008191C(s32 arg0){
    ...
    switch(D_800E69C0.unk3C.uchar[0]){
        ...
        case 1:
            ...
            D_800E69C0.unk3C.uchar[1] = 0;
            D_800E69C0.unk3E[0].uchar[0] = 1;
            D_800E69C0.unk3E[0].uchar[1] = 0x3C;

            D_8016B0B4 = 255.0 / (f32)D_800E69C0.unk3E[0].uchar[1];
            D_8016B0B0 = 0.0f;
        ...
        case 2:
            if(((&D_800F3940)[cdata.unk41]->unk30 == 1 && D_800E69C0.unk3E[1].uchar[0] & 2) || (&D_800E6A2C)[D_800E69C0.unk3E[1].uchar[1]][0] > 0x37){
                ...
                do{func_80013ECC(D_800E6A20, D_800E69C0.unk3E[1].uchar[1]);}while(0);
